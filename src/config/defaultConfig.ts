...
const config: SiteConfig = {
  ...
  website: {
    title: "Secret Blog", // Homepage title
    titleShort: "S-Blog", // Short site title for homescreen (PWA). Preferably should be under 12 characters to prevent truncation
    name: "Development Secret Blog", // Website name used for homescreen (PWA) and SEO
    description: "Secret Blog for me", // Website description used for RSS feeds/meta description tag
    language: "ko", // Sets the global HTML lang attribute
    logoUrl: "/logos/logo-1024.png", // Logo used for SEO
    url: "https://secret-blog.netlify.app/", // Domain of your website without the pathPrefix
