...
// Config
import { withBasePath, withDefaults } from "../src/config";
  ...
  return {
    ...
    siteMetadata: {
      ...
      rssMetadata: {
        ...
        feed_url: urljoin(config.website.url, config.pathPrefix, config.website.rss),
        title: config.website.title,
        description: config.website.description,
        image_url: `${urljoin(config.website.url, config.pathPrefix)}${config.website.logoUrl}`,
    ...
    plugins: [
      ...
      },
      {
        ...
        options: {
          modulePath: fs.existsSync(netlifyConfigPath) ? netlifyConfigPath : undefined,
